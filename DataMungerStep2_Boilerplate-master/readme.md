...
1. Clone the base boilerplate in the folder **assignment-solution-step2** of your local machine
    ...
    `git clone https://gitlab-jpmc.stackroute.in/stack_java_datamunging/DataMungerStep2_Boilerplate.git assignment-solution-step2`
...
5. Add your new repository reference as remote
     ...
     `git remote add origin https://gitlab-jpmc.stackroute.in/{{yourusername}}/assignment-solution-step2.git`
